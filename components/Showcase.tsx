...
const SCREENS: Screen[] = [
  ...
  },
  {
    ...
    icon: <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm10-3v6m3-3h-6" />,
  },
  {
  ...
  {
    src: "/product-img/products-screen.png",
    label: "Products",
    desc: "Manage and browse your full product inventory.",
    icon: <path d="M21 16V8a2 2 0 0 0-1-1.7l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.7l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16zM3.3 7L12 12l8.7-5M12 22V12" />,
  },
  {
  ...
  },
  {
    ...
    icon: <path d="M20.6 13.4L13.4 20.6a2 2 0 0 1-2.8 0l-7.2-7.2A2 2 0 0 1 3 12V4h8a2 2 0 0 1 1.4.6l8.2 8.2a2 2 0 0 1 0 2.6zM7 7h.01" />,
  },
  {
  ...
  },
  {
    ...
    icon: <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm14 10v-2a4 4 0 0 0-3-3.87M16 3.13A4 4 0 0 1 16 11" />,
  },
];
        ...
        <div className="gallery-more">
          ...
          >
            ...
            <svg
              ...
              aria-hidden="true"
            >
              <path d={showAll ? "M19 12H5M11 18l-6-6 6-6" : "M5 12h14M13 6l6 6-6 6"} />
            </svg>
          </button>
        </div>
      )}
